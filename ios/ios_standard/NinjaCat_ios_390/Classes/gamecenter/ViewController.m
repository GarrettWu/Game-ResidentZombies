...
- (void)reportScore {
    [[GameCenterManager sharedManager] saveAndReportScore:33333 leaderboard:@"com.mtstudio.ninjacat.leaderboard.highscore"];
//    GKScore *score = [[[GKScore alloc]
//                       initWithCategory:@"com.mtstudio.ninjacat.leaderboard.highscore"] autorelease];
//    score.value = 2000+rand()%2000;
...
//            // Create score object
//            GKScore *scoreReporter = [[[GKScore alloc] initWithCategory:@"com.mtstudio.ninjacat.leaderboard.highscore"] autorelease];
//            
//            // Set the score value
//            scoreReporter.value = 2000+rand()%2000;
//            
//            // Try to send
...
- (void)showLeaderboard {
    if([[GameCenterManager sharedManager] isGameCenterAvailable]) {
        ...
        leaderboardViewController.category = @"com.mtstudio.ninjacat.leaderboard.highscore";
