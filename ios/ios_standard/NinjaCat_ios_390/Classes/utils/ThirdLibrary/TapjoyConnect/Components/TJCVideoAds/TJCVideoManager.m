...
{
	TJCTBXMLElement *videoElement = [TJCTBXML childElementNamed:@"TapjoyVideo" parentElement:(TJCTBXMLElement*)dataObj];
	NSString *shouldAutoCache = [TJCTBXML valueOfAttributeNamed:@"cache_auto" forElement:(TJCTBXMLElement*)dataObj];
	NSString *shouldCacheWifi = [TJCTBXML valueOfAttributeNamed:@"cache_wifi" forElement:(TJCTBXMLElement*)dataObj];
	NSString *shouldCacheMobile = [TJCTBXML valueOfAttributeNamed:@"cache_mobile" forElement:(TJCTBXMLElement*)dataObj];
